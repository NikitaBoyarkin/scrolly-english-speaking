...
const vizRenderers: Record<string, VizRenderer> = {
  ...
  outcomes: (id, props) =>
    import('./viz/outcomes').then((m) => m.render(id, props as Parameters<typeof m.render>[1])),
  cefr: (id, props) =>
    import('./viz/cefr').then((m) => m.render(id, props as Parameters<typeof m.render>[1])),
  quiz: (id, props) =>
    import('./viz/quiz').then((m) => m.render(id, props as Parameters<typeof m.render>[1])),
  calendar: (id, props) =>
